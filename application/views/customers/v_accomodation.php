          ...
          <div class="col-md-4">
            ...
            <div class="card card-widget">
              <div class="card-header">
                <center>
                  <h3>Kevin Holand Homestay</h3>
                </center>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <img class="img-fluid pad" src="<?php echo base_url().'theme/images/Ecomerse/photo2.png'?>" alt="Photo">
                <br><br>
                <h5>Fasilitas</h5>
                <center><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                tempor incididunt ut labore et dolore magna aliqua.</p></center>
                <hr>
                <p class="mb-0"><b> Booking</b></p>
                <span class="text-muted mt-0">Rp. 100.000 / Hari</span>
                <button type="button" class="float-right btn btn-default btn-sm mt-0"><i class=""></i> BOOKING</button>
              </div>
            </div>
            <!-- /.card -->
          </div>
