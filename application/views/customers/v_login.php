...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="../../index2.html" class="h1"><b>Anak</b> Tao</a>
    </div>
    <div class="card-body">
      ...
      <p class="mb-1">
        Silahkan <a href="forgot-password.html">Forgot Password</a>
      </p>
      <p class="mb-0">
        Belum punya Akun? Silahkan <a href="<?php echo base_url().'customers/register'?>" class="text-center">Register</a>
      </p>
    </div>
    <!-- /.card-body -->
  </div>
