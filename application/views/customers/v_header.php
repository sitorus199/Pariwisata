  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a href="<?php echo base_url().'customers/destinasi'?>" class="nav-link">Destination</a>
          </li>
          <li class="nav-item">
            <a href="<?php echo base_url().'customers/accomodation'?>" class="nav-link">Accomodation</a>
          </li>
          <li class="nav-item">
