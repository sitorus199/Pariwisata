...
<div class="wrapper">
          ...
          $no=0;
            foreach ($data->result_array() as $i) :
               $no++;
                ...
                $ket=$i['keterangan'];
                $status=$i['status'];
                $namadestinasi=$i['nama_paket'];

                    ?>
                    <tr>
                      <td><?php echo $adult; ?></td>
                      <td><a href="#ModalDetail<?php echo $id;?>" data-toggle="modal" title="Lihat Detail"><?php echo $namadestinasi; ?></a></td>
                      <td><?php echo $id_paket; ?></td>
                      <td><?php echo $ket; ?></td>
                      <td><?php echo rupiahh($total); ?></td>
                      <td>
                        <?php if($status=='LUNAS'): ?>
                      ...
                      <?php else:?>
                        <a class="btn btn-xs btn-danger" href="#ModalHapus<?php echo $id;?>" data-toggle="modal" title="Batalkan"><button type="button" class="btn btn-block btn-danger">Batal</button> </a>


                      
                        <a class="btn btn-xs btn-success" href="#ModalKonfirmasi<?php echo $id;?>" data-toggle="modal" title="Konfirmasi"><button type="button" class="btn btn-block btn-success">Bayar</button> </a>
                        <?php endif ?>
                      </td>
                    </tr>
                    <?php endforeach;?>
          ...
          $no=0;
            foreach ($datadestinasi->result_array() as $i) :
               $no++;
                ...
                $ket=$i['keterangan'];
                $status=$i['status'];
                $namadestinasi=$i['nama_destinasi'];
          ...
          $no=0;
            foreach ($dataakomodasi->result_array() as $i) :
               $no++;
                ...
                $ket=$i['keterangan'];
                $status=$i['status'];
                $namadestinasi=$i['nama_akomodasi'];
          ...
          $no=0;
            foreach ($datatransportasi->result_array() as $i) :
               $no++;
                ...
                $ket=$i['keterangan'];
                $status=$i['status'];
                $namadestinasi=$i['nama_transportasi'];
  ...
  <?php endforeach;?>
  <?php foreach ($datadestinasi->result_array() as $i) :
                $id=$i['id'];
                $id_paket=$i['id_paket'];
                $tgl=$i['tanggal'];
                $nama=$i['nama'];
  ...
  <?php endforeach;?>
  <?php foreach ($dataakomodasi->result_array() as $i) :
                $id=$i['id'];
                $id_paket=$i['id_paket'];
                $tgl=$i['tanggal'];
                $nama=$i['nama'];
  ...
  <?php endforeach;?>
  <?php foreach ($datatransportasi->result_array() as $i) :
                $id=$i['id'];
                $id_paket=$i['id_paket'];
                $tgl=$i['tanggal'];
                $nama=$i['nama'];
  ...
  <!--Modal Konfirmasi Pengguna-->
        <div class="modal fade" id="ModalKonfirmasi<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-eader"><center>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                    ...
                    <div class="modal-body">
                     <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                            <p>Silahkan Upload Bukti Pembayaran  <b> <?php echo $namadestinasi;?>  </b>Anda !!</p>

                    </div>
                    <div class="form-group row">
                        <label for="inputUserName" class="col-sm-4 control-label ml-3">Jumlah Transfer</label>
                        <div class="col-sm-7">
                          <input type="hidden" value="<?php echo $id_paket;?>" name="xidpaket">
                          <input type="hidden" value="<?php echo $nama;?>" name="xnama">
                          ...
                          <input type="text" min="1" name="xjumlah" class="form-control" id="inputEmail" placeholder="Jumlah Transfer " value="<?php echo $total;?>" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
  ...
  <?php endforeach;?>
                  ...
                  <div class="tab-pane" id="settings">
                     <form class="form-horizontal" action="<?php echo base_url().'customers/profile/update_pengguna'?>" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group row">
                        <label for="inputName2" class="col-sm-2 col-form-label">Moto</label>
                        <div class="col-sm-10">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="xnohp" class="form-control" id="inputName2" value="<?php echo $c['pengguna_nohp'];?>">
                        </div>
                      </div>
                      <div class="form-group row">
