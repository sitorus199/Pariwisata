...
<head>
  ...
  <title>Anak Tao | Paket Wisata</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content"> 
      ...
      foreach ($brt->result_array() as $b) {
        $id=$b['id_paket_wisata'];
        $nama=$b['nama_paket'];
        $transportasi=$b['transportasi'];
        $akomodasi=$b['akomodasi'];
        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-12 col-sm-4">
              ...
              <div class="mt-3 product-share">
                <a href="#" class="text-gray">
                  <?php echo 'Destinasi Ke '. $destinasi;?>
                  <!-- <i class="fas fa-utensils fa-2x"></i> -->
                </a>
                <a href="#" class="text-gray">
                  <?php echo 'Dengan Akomodasi '. $akomodasi;?>
                  <!-- <i class="fab fa-beach fa-2x"></i> -->
                </a>
                <a href="#" class="text-gray">
                  <?php echo ' dan Transportasi '. $transportasi;?>
            ...
            <div class="col-12 col-sm-4">
              <!-- ketiga -->
              <center>
              <h4 class="mt-3"><small>Lokasi</small></h4>
              <div class="btn-group btn-group-toggle" data-toggle="buttons">
                <label class="btn btn-default text-center">
                  <input type="radio" name="color_option" id="color_option_b1" autocomplete="off">
                  <span class="text-xl"><?php echo $lokasi;?></span>&nbsp
      ...
      <div class="modal fade" id="modal-default<?php echo $id;?>">
        <div class="modal-dialog">
          <form class="form-horizontal" action="<?php echo base_url().'customers/paketwisata/simpan_pemesanan'?>" method="post" enctype="multipart/form-data">
