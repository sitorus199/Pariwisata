        ...
        <div class="card-body">
          <div class="row">
            <div class="col-12 col-sm-6">
              ...
              <div class="col-12 col-sm-12 product-image-thumbs">
                <div class="product-image-thumb active"><img src="<?php echo base_url().'assets/images/'.$gbr;?>" alt="Product Image"></div>
                <div class="product-image-thumb" ><img src="<?php echo base_url().'assets/images/'.$gbr;?>" alt="Product Image"></div>
                <div class="product-image-thumb" ><img src="<?php echo base_url().'assets/images/'.$gbr;?>" alt="Product Image"></div>
                <div class="product-image-thumb" ><img src="<?php echo base_url().'assets/images/'.$gbr;?>" alt="Product Image"></div>
                <div class="product-image-thumb" ><img src="<?php echo base_url().'assets/images/'.$gbr;?>" alt="Product Image"></div>
              </div>
            ...
            <div class="col-12 col-sm-6">
              ...
              <h4 class="mt-3">Available Tiket</h4>
              <div class="btn-group btn-group-toggle" data-toggle="buttons">
                <label class="btn btn-default text-center">
                  <input type="radio" name="color_option" id="color_option_b1" autocomplete="off">
                  <span class="text-xl"><?php echo $stock;?></span>
                  <br>
                  Tiket
                </label>
              ...
              <div class="mt-4">
                <div class="btn btn-primary btn-lg btn-flat" data-toggle="modal" data-target="#modal-default<?php echo $id;?>">
                  <i class="fas fa-cart-plus fa-lg mr-4"></i>
                  Add to Cart
                </div>
          ...
          <div class="row mt-4">
            ...
            <div class="tab-content p-3" id="nav-tabContent">
              <div class="tab-pane fade show active" id="product-desc" role="tabpanel" aria-labelledby="product-desc-tab"><?php echo $deskripsi;?> </div>
              <div class="tab-pane fade" id="product-comments" role="tabpanel" aria-labelledby="product-comments-tab"><?php echo $fasilitas;?></div>
