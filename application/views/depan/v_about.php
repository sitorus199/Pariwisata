                ...
                <div class="col-md-12">
                    <div class="single-item">
                        <div class="quote">
                            ...
                            <p class="quote_text">Anak Tao benar-benar mengagumkan. Saya sangat senang bisa bergabung dengan Komunitas Anak Tao dan menjadi pengalaman terbaik tahun ini.</p>
                            <div class="testi-img_block">
                                <img src="<?php echo base_url().'theme/images/student-1.png'?>" class="img-fluid" alt="#">
                                <p><span>Hernandez Alvaro</span>Pengunjung</p>
                            </div>
                        </div>
                        <div class="quote">
                            <i class="fa fa-quote-left" aria-hidden="true"></i>
                            <p class="quote_text">Anak TAo benar-benar Keren. Komunitas yang memajukan dan melestarikan Alam dengan cara yang disenangi banyak orang. </p>
                            <div class="testi-img_block">
                                <img src="<?php echo base_url().'theme/images/student-2.png'?>" class="img-fluid" alt="#">
                                <p><span>Elanoar Rigby</span>Pengunjung</p>
                            </div>
                        </div>
                    </div>
                </div>
