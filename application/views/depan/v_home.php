...
<head>
    ...
    <title>Anak Tao - Selamat Datang di Samosir</title>
                            ...
                            <ul class="navbar-nav">
                                ...
                                <!-- <li class="user-footer">
                                    <div class="pull-right">
                                        <a href="<?php echo base_url().'admin/login/logout'?>" class="btn btn-default btn-flat">Login</a>
                                    </div>
                                </li> -->
                             </ul>
                        </div>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="foot-logo">
                    ...
                    <p><?php echo date('Y');?> © copyright by <a href="http://anaktao.com" target="_blank">Anak Tao</a>. <br>All rights reserved.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="sitemap">
