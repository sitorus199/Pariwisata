...
<head>
  ...
  <title>Anak Tao | List Berita</title>
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url().'admin/tulisan'?>"><i class="fa fa-list"></i> List Event</a></li>
  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) Berita -->
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" href="<?php echo base_url().'admin/tulisan/add_tulisan'?>"><span class="fa fa-plus"></span> Post Event</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
