...
<head>
  ...
  <title>Anak Tao | Data Akomodasi</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Data Akomodasi</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Add Akomodasi</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2017 <a href="http://anaktao.com">Anak Tao</a>.</strong> All rights reserved.
  </footer>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Add Akomodasi</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'admin/akomodasi/simpan_akomodasi'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">

                            <div class="form-group">
                                <label for="inputUserName" class="col-sm-4 control-label">Nama Akomodasi</label>
                                <div class="col-sm-7">
                                  <input type="text" name="xjudul" class="form-control" id="inputUserName" placeholder="Nama Transpotasi" required>
                                </div>
                            </div>
                            <div class="form-group">
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Edit Akomodasi</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'admin/akomodasi/update_akomodasi'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                  ...
                                  <input type="text" name="xjudul" class="form-control" value="<?php echo $nama;?>" id="inputUserName" placeholder="Nama Transportasi" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputUserName" class="col-sm-4 control-label">Deskripsi</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                  <input type="text" name="xstock" class="form-control" value="<?php echo $stok;?>" id="inputUserName" placeholder="Stok" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputUserName" class="col-sm-4 control-label">Photo</label>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Hapus Akomodasi</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'admin/akomodasi/hapus_akomodasi'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
							<input type="hidden" name="kode" value="<?php echo $id;?>"/>
                            <p>Apakah Anda yakin mau menghapus akomodasi <b><?php echo $nama;?></b> ?</p>
...
<?php if($this->session->flashdata('msg')=='error'):?>
    ...
    <?php elseif($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Akomodasi Berhasil disimpan ke database.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
    ...
    <?php elseif($this->session->flashdata('msg')=='info'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Info',
                    text: "Akomodasi berhasil di update",
                    showHideTransition: 'slide',
                    icon: 'info',
                    hideAfter: false,
                    position: 'bottom-right',
    ...
    <?php elseif($this->session->flashdata('msg')=='success-hapus'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Akomodasi Berhasil dihapus.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
