...
<head>
  ...
  <title>Anak Tao | Registration</title>
...
<div class="register-box">
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      <p class="login-box-msg">Silahkan Daftar Akun Anda</p>

      <form action="<?php echo site_url().'admin/login/registration'?>" method="post">
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="username" placeholder="User name" value="<?= set_value('username'); ?>">
      ...
      Telah Memiliki <a href="<?php echo base_url().'admin/login'?>" class="text-center">Akun</a>
    </div>
    <!-- /.form-box -->
  </div><!-- /.card -->
</div>
