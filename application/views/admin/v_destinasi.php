...
<head>
  ...
  <title>Anak Tao | Data Destinasi</title>
				...
				<?php
					$no=0;
  					foreach ($data->result_array() as $i) :
  					   $no++;
                       $id=$i['id_destinasi'];
                       $nama=$i['nama_destinasi'];
                       $deskripsi=$i['deskripsi'];
                       $alamat=$i['alamat_destinasi'];
                       $harga=$i['harga'];
                       $stok=$i['stock'];
                       $gambar=$i['gambar'];
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/destinasi/update_destinasi'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="inputUserName" class="col-sm-4 control-label">Alamat</label>
                                <div class="col-sm-7">
                                  <input type="text" name="xalamat" class="form-control" value="<?php echo $alamat;?>" id="inputUserName" placeholder="Nama Destinasi" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputUserName" class="col-sm-4 control-label">Harga</label>
                            ...
                            <div class="form-group">
                                <label for="inputUserName" class="col-sm-4 control-label">Stock</label>
                                <div class="col-sm-7">
                                  <input type="text" name="xstock" class="form-control" value="<?php echo $stok;?>" id="inputUserName" placeholder="Nama Destinasi" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputUserName" class="col-sm-4 control-label">Fasilitas</label>
                                <div class="col-sm-7">
                                  <input type="text" name="xfasilitas" class="form-control" value="<?php echo $fasilitas;?>" id="inputUserName" placeholder="Nama Destinasi" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputUserName" class="col-sm-4 control-label">Photo</label>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/destinasi/hapus_destinasi'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
							       <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                     <input type="hidden" value="<?php echo $gambar;?>" name="gambar">
                            <p>Apakah Anda yakin mau menghapus destinasi <b><?php echo $nama;?></b> ?</p>
