...
<?php
    ...
    $query4=$this->db->query("SELECT * FROM tbl_pembayaran JOIN tbl_order WHERE status<>'LUNAS'");
...
<head>
  ...
  <title>Anak Tao | Data Konfirmasi</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Data Konfimasi</li>
      </ol>
    </section>
              ...
              <table id="example1" class="table table-striped" style="font-size:12px;">
                ...
                <tr>
                  ...
                  <td style="text-align:right;">
                        <a class="btn" data-toggle="modal" data-target="#ModalCheckBukti<?php echo $id;?>"><span class="fa fa-eye"></span></a>
...
<!-- ./wrapper -->
		...
		<?php foreach ($data->result_array() as $i) :
            ...
            ?>
	<!--Modal Edit Pengguna-->
        <div class="modal fade" id="ModalCheckBukti<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/konfirmasi/pembayaran_selesai'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">

                      <input name="kode" type="hidden" value="<?php echo $order_id;?>">
                      <img height="410" src="<?php echo base_url().'assets/images/'.$photo;?>">
                          
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default btn-flat" data-dismiss="modal">Cancle</button>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Hapus Buti Bayar</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'admin/konfirmasi/hapus_konfirmasi'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
							       <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                        <p>Apakah Anda yakin mau menghapus hasil konfirmasi <b><?php echo $order_id;?></b> ?</p>
