...
<head>
  ...
  <title>Anak Tao | Forgot Password</title>
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      ...
      <form action="<?php echo site_url().'admin/login/forgotpassword'?>" method="post">
      ...
      <p class="mb-0">
        Kembali ke halaman <a href="<?php echo base_url().'admin/login'?>" class="text-center">Login</a>
      </p>
    </div>
    <!-- /.card-body -->
  </div>
