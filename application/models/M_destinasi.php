...
class M_destinasi extends CI_Model{
	...
	function simpan_pemesanan($id,$nama,$alamat,$email,$notelp,$mulai,$akhir,$metode,$jumlah,$tanggal,$keterangan,$status){
		$hsl=$this->db->query("INSERT INTO tbl_order(id_paket,nama,alamat,no_telp,email,berangkat,kembali,metode_id,adult,paket_id_order,tanggal,keterangan,status) VALUES ('$id','$nama','$alamat','$notelp','$email','$mulai','$akhir','$metode','$jumlah','$id','$tanggal','$keterangan','$status')");
		return $hsl;
	}
